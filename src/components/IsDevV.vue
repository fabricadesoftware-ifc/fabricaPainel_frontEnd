<template>
  <div class="w-screen h-screen d-flex justify-center pt-16">
    <div class="mt-16">
      <svg
        height="342.09"
      ...
      <div class="text-center mt-4">
        <h1 class="pt-4 font-weight-bold text-h2 color">Em desenvolvimento</h1>
        <p class="text-center mt-4" style="font-size: 0.9rem">
          <router-link
            class="d-inline-block text-decoration-none text-primary mt-8 text-h6"
            to="/"
