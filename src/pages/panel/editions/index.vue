  ...
  <LayoutPanel>
    <v-container class="w-100">
      <div class="d-flex flex-row flex-wrap ga-4">
          ...
          >
            ...
            >
              ...
              >
                ...
                <div>
                  <v-chip class="text-capitalize bg-yellow" text-color="white"
                    >Em Breve</v-chip
                  >
                </div>
                <div>
                  <v-btn
                    ...
                    "
                    flat
                    @click="selectCard(Number(upcomingEditions[0]?.id))"
                    ><img src="@/assets/icons/externalLink.svg" alt="" />Ver
                    Edição</v-btn
                  >
                </div>
              </v-row>
              ...
              >
                ...
                <div>
                  <v-btn
                    ...
                    "
                    flat
                    @click="selectCard(Number(openEdition?.id))"
                    ><img src="@/assets/icons/externalLink.svg" alt="" />Ver
                    Edição</v-btn
                  >
                </div>
        ...
        <div
          v-else-if="!openEdition && !upcomingEditions.length"
          class="mb-8 mt-10 w-100 px-16"
          style="
            display: flex;
        ...
        >
          <h1
            :style="{ fontSize: width > 780 ? '32px' : '20px' }"
          ...
          <v-btn
            ...
            :style="{ fontSize: width > 780 ? '20px' : '16px' }"
            ><img
              src="@/assets/icons/AddIcon.svg"
              :style="{ width: width > 780 ? '32px' : '20px' }"
              alt=""
            />Cadastrar Edição</v-btn
          >
        </div>
        ...
        >
          <h2 v-if="closedEditions.length" class="mt-8 mb-5 w-100">
            Edições Anteriores
          </h2>
          <v-card
            v-for="edition in closedEditions.slice().reverse()"
            :key="edition.id"
            class="border-md w-100"
            rounded="xl"
            variant="outlined"
          >
            ...
            >
              ...
              >
                ...
                <div>
                  <v-chip class="text-capitalize bg-primary" text-color="white"
                    >Concluida</v-chip
                  >
                </div>
                <div>
                  <p
                    ...
                    style="
                      ...
                      cursor: pointer;
                    "
                    @click="selectCard(Number(edition?.id))"
                  >
                    <img src="@/assets/icons/externalLink.svg" alt="" /> Ver
                    Edição
                  </p>
