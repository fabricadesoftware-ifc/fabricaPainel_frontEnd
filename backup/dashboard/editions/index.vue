  ...
  <LayoutDashboard>
    <v-container>
            ...
            <v-row>
              ...
              <v-col>
                <img
                  ...
                  :src="
                    editionStore.currentEdition?.banner?.file ?? defaultBanner
                  "
                />
              </v-col>
            </v-row>
                  ...
                  <v-card-text class="px-10 py-4">
                    <v-form v-model="valid" @submit.prevent="saveEdition">
                      ...
                      <v-text-field
                        ...
                        label="Data Inicial de Submissão"
                        rounded="xl"
                        type="date"
                        variant="outlined"
                      />
                      ...
                      <v-text-field
                        ...
                        label="Data Inicial de Orientadores"
                        rounded="xl"
                        type="date"
                        variant="outlined"
                      />
                      <v-text-field
                        ...
                        label="Data Final de Orientadores"
                        rounded="xl"
                        type="date"
                        variant="outlined"
                      />
                      <v-text-field
                        ...
                        label="Data Inicial de Avaliadores"
                        rounded="xl"
                        type="date"
                        variant="outlined"
                      />
                      <v-text-field
                        ...
                        label="Data Final de Avaliadores"
                        rounded="xl"
                        type="date"
                        variant="outlined"
                      />
                      <v-text-field
                        ...
                        label="Data Inicial de Registro de Tema"
                        rounded="xl"
                        type="date"
                        variant="outlined"
                      />
                      <v-text-field
                        ...
                        label="Data Final de Registro de Tema"
                        rounded="xl"
                        type="date"
                        variant="outlined"
                      />
                      <v-text-field
                        ...
                        label="Data Inicial de Registro de Avaliadores"
                        rounded="xl"
                        type="date"
                        variant="outlined"
                      />
                      <v-text-field
                        ...
                        label="Data Final de Registro de Avaliadores"
                        rounded="xl"
                        type="date"
                        variant="outlined"
                      />
      ...
      <template v-else>
        <v-alert
          color="info"
          icon="mdi-alert-circle-outlined"
          outlinedd
          rounded="lg"
          text="Não há uma edição atual disponível no momento."
          variant="tonal"
        />
      </template>
    </v-container>
